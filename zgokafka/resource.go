...
//   Consumer(topic, groupId string) (*sarama.Consumer, error) //自定义的func
// }
...
// //初始化消费者
// func (n *kafkaResource) Consumer(topic, groupId string) (*sarama.Consumer, error) {
...
//   config.Group.Mode = sarama.ConsumerModePartitions
...
//     }
//   }
//   consumer, err := sarama.NewConsumer(brokers, groupId, []string{topic}, config)
//   if err != nil {
//     fmt.Println(err)
//     return nil, err
//   }
